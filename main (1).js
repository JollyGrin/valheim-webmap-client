(() => {
    "use strict";
    const e = { CANVAS_WIDTH: 2048, CANVAS_HEIGHT: 2048, PIXEL_SIZE: 12, EXPLORE_RADIUS: 100, DEFAULT_ZOOM: 200, ALWAYS_MAP: !1, ALWAYS_VISIBLE: !1 };
        ...
        s = {
            players: (e, t) => {
                ...
                s.forEach((e) => {
                    ...
                    const n = { id: t.shift(), name: t.shift(), health: t.shift(), maxHealth: t.shift(), flags: { dead: !1, pvp: !1, inbed: !1 } };
                    if (("hidden" == t[0] ? ((n.hidden = !0), t.shift()) : (n.hidden = !1), void 0 !== t[0])) {
                    ...
                    if (void 0 !== t[0]) {
                        const e = t.shift(),
                            s = ["dead", "pvp", "inbed"];
                        console.log(e);
                        for (let t = 0; t < s.length; t++) console.log(t + " " + s[t] + " " + e[t]), (n.flags[s[t]] = Boolean(Number(e[t])));
                    }
                    i.push(n);
                }),
                    n.players.forEach((e) => {
    ...
    const O = (e) => {
        ...
        (Math.abs(n) > 0.5 || Math.abs(s) > 0.5) && ((h.style.left = n + h.offsetLeft + "px"), (h.style.top = s + h.offsetTop + "px"));
    };
    let M = !1;
    const W = () => {
                ...
                T.forEach((e) => {
                    ...
                    e.el ||
                        ...
                        (e.el = ((e) => {
                            ...
                            (t.id = e.id), (t.className = `mapText mapIcon ${e.type}`), e.zIndex && (t.style.zIndex = e.zIndex);
                            const n = document.createElement("div");
                            return (n.className = "center text"), (n.textContent = e.text), t.appendChild(n), e.node && t.appendChild(e.node), t;
                        })(e)),
                        h.appendChild(e.el));
    ...
    const R = (e) => {
        ...
        b = () => {
            A.clearRect(0, 0, L, E), (A.globalCompositeOperation = "source-over"), A.drawImage(v, 0, 0), (A.globalCompositeOperation = "multiply"), A.drawImage(I, 0, 0), W();
        },
        z = function (e, t, n) {
            void 0 === t && ((t = window.innerWidth / 2), (n = window.innerHeight / 2));
            const s = _,
                i = 8e3 * devicePixelRatio;
            (e = Math.min(Math.max(Math.round(e), 50), i)), (_ = e), (h.style.width = `${e}%`), (h.style.height = h.offsetWidth + "px");
            const a = _ / s;
            (h.style.left = a * (h.offsetLeft - t) + t + "px"), (h.style.top = a * (h.offsetTop - n) + n + "px"), W();
        };
    let P;
    const N = (e) => {
            (L = t.CANVAS_WIDTH),
            ...
            ((e, t) => {
                ...
                let s = [];
                const i = (e) => {
                    n.delete(e.pointerId), (s = s.filter((t) => t.event.pointerId !== e.pointerId)), t.up && t.up(s);
                };
                ...
                down: (e) => {
                    1 === e.length ? ((s.x = h.offsetLeft), (s.y = h.offsetTop)) : 2 === e.length && ((a = !0), (i = void 0));
                },
                move: (e) => {
                    if (1 !== e.length || a || C) {
                        if (2 === e.length) {
                            const t = e[0].event.clientX,
                                ...
                                l = s - o,
                                c = Math.sqrt(d * d + l * l);
                            i && n({ deltaY: i - c || -1, clientX: (t + a) / 2, clientY: (s + o) / 2 }, 0.08), (i = c);
                        }
                    } else {
                        const t = e[0].event;
                        (h.style.left = s.x + (t.clientX - e[0].downEvent.clientX) + "px"), (h.style.top = s.y + (t.clientY - e[0].downEvent.clientY) + "px"), W();
                    }
                },
                up: (e) => {
                    0 === e.length && (a = !1);
    ...
    const j = (e) => {
            Z && Z.playerListEntry.el.classList.remove("selected"),
                e && e !== Z
                    ...
                    : ((Z = null), X(null), r.map.classList.remove("smooth"), (r.topMessage.textContent = ""));
        },
        G = () => {
                        ...
                        if (!n) {
                            ...
                            (s.ui.name.textContent = e.name),
                                ...
                                s.el.addEventListener("click", () => {
                                    n.hidden || (r.playerListTut && (r.playerListTut.remove(), (r.playerListTut = void 0)), j(n));
                                }),
                                r.playerList.appendChild(s.el);
                        }
                        (!t.ALWAYS_VISIBLE && e.hidden) || !n.hidden
                            ? t.ALWAYS_VISIBLE || !e.hidden || n.hidden || (k(n), (n.playerListEntry.ui.details.style.display = "none"), Z === n && j(null))
                            ...
                            console.log(e.flags),
                            console.log(n.flags),
                            (n.playerListEntry.ui.hp.style.width = 100 * Math.max(e.health / e.maxHealth, 0) + "%"),
    ...
    (async () => {
            ...
            fetch("pins")
                ...
                .then((e) => {
                    e.split("\n").forEach((e) => {
                        const t = e.split(",");
                        if (t.length > 5) {
                            const e = { id: t[1], uid: t[0], type: t[2], name: t[3], x: t[4], z: t[5], text: t[6], static: !0 };
                            H(e, !1);
                        }
                    }),
                        $();
        ...
        i.forEach((e) => {
            ...
            r.hideMessageList.addEventListener("change", () => {
                r.hideMessageList.checked ? (r.messageList.style.left = -r.messageList.offsetWidth + "px") : (r.messageList.style.left = 0);
            }),
            r.hidePlayerList.addEventListener("change", () => {
                r.hidePlayerList.checked ? (r.playerListContainer.style.right = -r.playerListContainer.offsetWidth + "px") : (r.playerListContainer.style.right = 0);
            }),
            G(),
            o.init();
    })();
